...
class _PatientRegistrationScreenState extends State<PatientRegistrationScreen>
    ...
    if (_formKey.currentState!.validate() &&
      ...
      try {
        ...
        final registrationData = RegistrationData(
          ...
          aadharNo: _aadharNumberController.text.trim(),
          address: _addressController.text.trim(),
          gender: _selectedGender,
          dob: _dobController.text
              .trim(), // Ensure this is in 'dd/MM/yyyy' format
          password: _passwordController.text.trim(),
        );

        // Call Supabase service to register the patient
        await SupabaseService().registerPatient(registrationData);
  ...
  Widget _buildPhoneField() {
    return TextFormField(
      ...
      textInputAction: TextInputAction.next,
      onFieldSubmitted: (_) =>
          FocusScope.of(context).requestFocus(_aadharNumberFocus),
      validator: (value) {
        if (value == null || value.isEmpty) {
